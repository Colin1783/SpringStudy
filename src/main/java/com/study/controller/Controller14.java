...
public class Controller14 {
	...
	public void sub1(Model model) {
		MyBean141 e1 = new MyBean141("Seoul", "Korea", 33, "흥민");
		MyBean142 e2 = new MyBean142();
		e2.setName("강인");
		e2.setId(22);
		e2.setAge(24);


		model.addAttribute("player1", e1);
		model.addAttribute("player2", e2);
	}
...
//		<p>${myBean142List[1].name}</p>
	...
	@RequestMapping("sub3")
	public void sub3(@ModelAttribute("player") MyBean142 o1) {
		o1.setName("오타니");
	}
	...
	public String sub11(MyBean146 o1) {
		return "/main14/sub11";
	}

	// /main14/sub12?car=tesla&price=2000&model=k5&country=us
	@RequestMapping("sub12")
	public void sub12(String car,
